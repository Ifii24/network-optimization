...
@variable(model, xAB_1 >= 0)
@variable(model, xAD_1 >= 0)
@variable(model, xBC_1 >= 0)
@variable(model, xBD_1 >= 0)
@variable(model, xCD_1 >= 0)
@variable(model, xDA_1 >= 0)
@variable(model, xDB_1 >= 0)
@variable(model, xDE_1 >= 0)
@variable(model, xEA_1 >= 0)
@variable(model, xAB_2 >= 0)
@variable(model, xAD_2 >= 0)
@variable(model, xBC_2 >= 0)
@variable(model, xBD_2 >= 0)
@variable(model, xCD_2 >= 0)
@variable(model, xDA_2 >= 0)
@variable(model, xDB_2 >= 0)
@variable(model, xDE_2 >= 0)
@variable(model, xEA_2 >= 0)
@variable(model, xAB_3 >= 0)
@variable(model, xAD_3 >= 0)
@variable(model, xBC_3 >= 0)
@variable(model, xBD_3 >= 0)
@variable(model, xCD_3 >= 0)
@variable(model, xDA_3 >= 0)
@variable(model, xDB_3 >= 0)
@variable(model, xDE_3 >= 0)
@variable(model, xEA_3 >= 0)
